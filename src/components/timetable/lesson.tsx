...
const MobileDayTimetableLesson: Component<{
  ...
  const Delimiter: Component<{ date: Date; }> = (props) => (
    <div class="flex items-center gap-2">
      <span class="h-[1px] w-4 border-b border-b-[rgb(200,200,200)] dark:border-b-[rgb(62,62,62)]" />

      <p class="flex-shrink-0 text-[rgb(120,120,120)] dark:text-[rgb(168,168,168)]">
        {getHourString(props.date)}
      </p>

      <span class="h-[1px] w-full border-b border-b-[rgb(200,200,200)] dark:border-b-[rgb(62,62,62)]" />
    </div>
  );
  ...
  return (
    <>
      <Show when={thereIsBreakBefore()}>
        ...
        <div class="flex justify-center items-center gap-6 py-4 text-[rgb(120,120,120)] dark:text-[rgb(168,168,168)]">
          <MdiTimerSandFull />
          <p>
      ...
      >
        <div class="flex flex-col gap-2 py-2.5 px-4 hover:bg-[rgb(236,236,236)] dark:hover:bg-[rgb(28,28,28)] transition-colors"
          classList={{
            "bg-red/16 dark:bg-red/8": isCurrentlyInLesson()
          }}
        >
          <div class="flex justify-between gap-2">
            <h2 class="text-lg text-[rgb(20,20,20)] font-500 dark:(text-[rgb(240,240,240)] font-400)">
            ...
            <div class="flex gap-2.5 items-center">
              ...
              <p class="text-sm bg-red/40 dark:bg-red rounded-full font-medium px-3 py-0.5 h-fit"
